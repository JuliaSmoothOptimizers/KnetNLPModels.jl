...
"""
reset_minibatch_train!(nlp :: KnetNLPModel{T,S,C}) where {T,S,C} = nlp.minbatch_train = create_minibatch(nlp.data_train[1], nlp.data_train[2], nlp.size_minibatch)
...
"""
reset_minibatch_test!(nlp :: KnetNLPModel{T,S,C}) where {T,S,C} = nlp.minbatch_test = create_minibatch(nlp.data_test[1], nlp.data_test[2], nlp.size_minibatch)
